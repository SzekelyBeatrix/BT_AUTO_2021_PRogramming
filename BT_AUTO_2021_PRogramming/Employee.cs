...
namespace BT_AUTO_2021_PRogramming
{
  public class Employee : Person
    ...
    public Employee(string firstName, string lastName, string address, string city, string country, double salary): base(firstName, lastName, address, city,country, salary)
      {
        this.salary = salary;
    }
